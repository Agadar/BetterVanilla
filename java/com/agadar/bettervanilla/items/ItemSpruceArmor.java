...
public class ItemSpruceArmor extends ItemArmor {
	...
	public ItemSpruceArmor(int armorType, String unlocalizedName)
	{
	...
	{
		if(stack.getItem() != ModItems.spruce_leggings)
		{
			return References.MODID + ":textures/models/armor/spruce_layer_1.png";
		}
		return References.MODID + ":textures/models/armor/spruce_layer_2.png";
	}
