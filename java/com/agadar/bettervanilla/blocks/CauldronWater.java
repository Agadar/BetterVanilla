...
public class CauldronWater extends Block
{
    ...
    {
        return par0Str.equals("inner") ? BetterVanilla.cauldronWater.field_94378_a : (par0Str.equals("bottom") ? BetterVanilla.cauldronWater.cauldronBottomIcon : null);
    }
    ...
    public boolean onBlockActivated(World par1World, int par2, int par3, int par4, EntityPlayer par5EntityPlayer, int par6, float par7, float par8, float par9)
    {
        ...
        if (itemstack.itemID == Item.bucketWater.itemID && j1 < 3)
        {
        ...
        else if (itemstack.itemID == Item.bucketLava.itemID && j1 <= 0)
        {
        	if (!par5EntityPlayer.capabilities.isCreativeMode)
        	{
        		par5EntityPlayer.inventory.setInventorySlotContents(par5EntityPlayer.inventory.currentItem, new ItemStack(Item.bucketEmpty));
        	...
        	par1World.setBlock(par2, par3, par4, BetterVanilla.cauldronLava.blockID, 3, 2);
        	par1World.func_96440_m(par2, par3, par4, BetterVanilla.cauldronLava.blockID);
        }              
        else if (j1 > 0)
        {
        	...
        	else if (itemstack.getItem() instanceof ItemArmor && ((ItemArmor)itemstack.getItem()).getArmorMaterial() == EnumArmorMaterial.CLOTH)
        	{
